...
import com.itis.android.firebasekhairrus.R.drawable
import com.itis.android.firebasekhairrus.R.id
import com.itis.android.firebasekhairrus.R.layout
...
class MainActivity : AppCompatActivity(), GoogleApiClient.OnConnectionFailedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        messageRecyclerView = findViewById(id.messageRecyclerView)
        ...
        firebaseAdapter = object : FirebaseRecyclerAdapter<Message, MessageViewHolder>(options) {
            ...
            override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MessageViewHolder {
                ...
                return MessageViewHolder(inflater.inflate(layout.item_message, viewGroup, false))
            }
        ...
        messageEditText = findViewById(id.messageEditText)
        messageEditText!!.filters = arrayOf<InputFilter>(LengthFilter(sharedPreferences!!
        ...
        addMessageImageView = findViewById(id.addMessageImageView)
    ...
    private fun putImageInStorage(storageReference: StorageReference, uri: Uri?, key: String) {
        storageReference.putFile(uri!!).addOnCompleteListener(this@MainActivity
            ...
            if (task.isSuccessful) {
                Log.d("RUSTEM", "successful")
                val message = Message(null, username, photoUrl,
                        task.result.metadata!!.downloadUrl!!.toString())
    ...
    companion object {
        ...
        private val MESSAGE_URL = "http://FirebasePhoneAuth.firebase.google.com/message/"

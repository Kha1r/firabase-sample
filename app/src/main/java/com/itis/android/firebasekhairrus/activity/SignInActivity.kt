...
class SignInActivity : AppCompatActivity(), GoogleApiClient.OnConnectionFailedListener {
    ...
    private var btnSignInWithPhone: Button? = null
    ...
    private fun initClickListeners() {
        ...
        btnResetPassword!!.setOnClickListener { ForgetPasswordActivity.start(this@SignInActivity) }
        ...
        btnSignInWithPhone!!.setOnClickListener { SignInWithPhoneActivity.start(this@SignInActivity) }
    }
